...
/**
 * Generate a simple base64 encoded token with expiration----no good for production
...
export function generateToken(user: {
  ...
  //It converts binary or text data into readable ASCII characters.
}
...
export async function getAuthToken(): Promise<string | null> {
  const cookieStore = await cookies(); //cookies() is Next.js.cookies API
